...
Por ejemplo, cuando se realiza el emparejamiento sin reemplazo, [Abadie & Spiess (2022)](https://doi.org/10.1080/01621459.2020.1840383) muestran que podemos estimar los errores estándar simplemente agrupando a nivel de pareja (o grupo) emparejado (**subclass** es una columna que enumera a las parejas o grupos emparejados y es construida automáticamente por *matchit*).
